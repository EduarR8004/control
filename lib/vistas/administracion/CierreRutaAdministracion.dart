...
import 'package:control/vistas/widgets/boton.dart';
...
class _CerrarCajaAdministradorState extends State<CerrarCajaAdministrador> {
  ...
  TextEditingController  retiroDia = new TextEditingController();
  TextEditingController  base = new TextEditingController();
  TextEditingController  baseDia = new TextEditingController();
  TextEditingController  gasto = new TextEditingController();
  TextEditingController  entregaDia = new TextEditingController();
  ...
  void initState() {
    ...
    retiroDia.text=0.0.toString();
    entregaDia.text=0.0.toString();
    gasto.text='0';
  ...
  crearCierre()async{
    ...
    session.baseSiguienteAdmin(valorEntrega,usuario).then((_){
      session.reporteDiarioAdmin(_recolectado.valorCuotas.toString(),gasto.text,_nuevaVenta.venta.toString(),base.text,entregaDia.text,valorEntrega.toString(),retiroDia.text,usuario).then((_){
        pr.hide();
        successDialog(
          context, 
  ...
  return FutureBuilder<List<AsignarAdmin>>(
    ...
    builder: (BuildContext context, AsyncSnapshot<List<AsignarAdmin>> snapshot) {
      if (snapshot.hasData) {
        ...
        base.text=_asignado.base.toString();
        return Padding(
          padding: const EdgeInsets.fromLTRB(8, 2, 8, 2),
          child: Column(
