import 'dart:core';
import 'dart:convert';
import 'package:control/modelos/Cartera.dart';
import 'package:control/modelos/ControlPrestamo.dart';
import 'package:control/modelos/Proyecto.dart';
import 'package:control/modelos/UsuarioAdministrador.dart';
import 'package:http/http.dart';
import 'package:intl/intl.dart';
import 'package:http/http.dart' as http;
import 'package:flutter/services.dart';
import 'package:control/modelos/Rol.dart';
import 'package:control/bd/Basedatos.dart';
import 'package:control/modelos/Venta.dart';
import 'package:control/modelos/Gasto.dart';
import 'package:control/utiles/Globals.dart';
import 'package:control/modelos/Claves.dart';
import 'package:control/modelos/Objeto.dart';
import 'package:control/modelos/Ventas.dart';
import 'package:control/modelos/Ciudad.dart';
import 'package:control/modelos/Cliente.dart';
import 'package:control/modelos/Asignar.dart';
import 'package:control/modelos/Usuarios.dart';
import 'package:control/modelos/Produccion.dart';
import 'package:control/modelos/RutaAdmin.dart';
import 'package:control/modelos/ConteoDebe.dart';
import 'package:control/modelos/ListarCaja.dart';
import 'package:control/modelos/AsignarAdmin.dart';
import 'package:control/modelos/CajaInicial.dart';
import 'package:control/modelos/ReporteGasto.dart';
import 'package:control/modelos/HistorialPago.dart';
import 'package:control/modelos/CuadresSemana.dart';
import 'package:universal_io/prefer_universal/io.dart';
import 'package:control/modelos/Agendamiento.dart';
import 'package:control/modelos/Departamento.dart';
import 'package:control/modelos/ReporteDiario.dart';
import 'package:control/modelos/TotalBloquedos.dart';
import 'package:control/modelos/ConteoDebeAdmin.dart';
import 'package:control/modelos/HistorialVenta.dart';
import 'package:control/modelos/TotalRutaAdmin.dart';
import 'package:control/modelos/ClienteBloqueado.dart';
...
class Insertar {
  ...
  enviarHistorial({bool actualizar})async{
    var fechaConsulta = format.format(now);
    var res = await DatabaseProvider.db.rawQuery("SELECT * FROM HistorialVenta WHERE fecha=?",[fechaConsulta]);
    _enviarClientes=[];
    for (var registro in res) {
      Map consulta={
        "fecha":registro["fecha"],
  ...
  reporteDiarioAdmin(recolectado,gasto,ventas,asignado,entrega,valorBaseDia,retiro,usuario)async{
    final format = DateFormat("yyyy-MM-dd");
    var outputFormat = DateFormat('hh:mm a');
    var fecha = format.format(now);
    var hora = outputFormat.format(now);
